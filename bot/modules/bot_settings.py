...
async def edit_bot_settings(client, query):
    ...
    if data[1] == 'close':
        ...
        if value and data[2] in ['OWNER_ID', 'DATABASE_URL', 'UPSTREAM_REPO', 'UPSTREAM_BRANCH'] and not await CustomFilters.owner(client, query):
            value = 'ɴᴏᴛʜɪɴɢ ᴛᴏ ꜱᴇᴇ ʜᴇʀᴇ ᴏᴋ ʙɪᴇ!'
