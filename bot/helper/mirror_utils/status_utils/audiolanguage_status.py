...
class AudioLanguageStatus:
    ...
    def status(self):
        return MirrorStatus.STATUS_AUDIOLANGUAGE
    ...
    async def cancel_download(self):
        LOGGER.info(f'Cancelling Audio language Changeing: {self.__name}')
        ...
        await self.__listener.onUploadError('Audio language Changeing stopped by user!')
