...
class IntroSubStatus:
    ...
    def status(self):
        return MirrorStatus.STATUS_INTROSUB
    ...
    async def cancel_download(self):
        LOGGER.info(f'Cancelling editing subtitle: {self.__name}')
        ...
        await self.__listener.onUploadError('editing subtitle stopped by user!')
