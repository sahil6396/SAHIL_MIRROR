...
class AudioRemoveStatus:
    ...
    def status(self):
        return MirrorStatus.STATUS_AUDIOREMOVE
    ...
    async def cancel_download(self):
        LOGGER.info(f'Cancelling Audio Removing: {self.__name}')
        ...
        await self.__listener.onUploadError('Audio Removing stopped by user!')
