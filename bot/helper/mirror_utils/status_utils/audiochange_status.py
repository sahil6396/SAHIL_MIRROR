...
class AudioChangeStatus:
    ...
    def status(self):
        return MirrorStatus.STATUS_AUDIOCHANGE
    ...
    async def cancel_download(self):
        LOGGER.info(f'Cancelling Audio Changeing: {self.__name}')
        ...
        await self.__listener.onUploadError('Audio Changeing stopped by user!')
