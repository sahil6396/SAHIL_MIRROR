...
class AudioBitrateStatus:
    ...
    def status(self):
        return MirrorStatus.STATUS_AUDIOBITRATE
    ...
    async def cancel_download(self):
        LOGGER.info(f'Cancelling Audio Bitrate Changeing: {self.__name}')
        ...
        await self.__listener.onUploadError('Audio Bitrate Changeing stopped by user!')
