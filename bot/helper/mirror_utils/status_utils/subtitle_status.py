...
class SubtitleStatus:
    ...
    def status(self):
        return MirrorStatus.STATUS_SUBTITLE
    ...
    async def cancel_download(self):
        LOGGER.info(f'Cancelling Subtiltes Url: {self.__name}')
        ...
        await self.__listener.onUploadError('Subtiltes Url stopped by user!')
